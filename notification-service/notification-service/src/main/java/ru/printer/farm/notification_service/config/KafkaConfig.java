package ru.printer.farm.notification_service.config;
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, TaskEventDto> consumerFactory() {
        ...
        JsonDeserializer<TaskEventDto> deserializer = new JsonDeserializer<>(TaskEventDto.class);
    ...
    public ConcurrentKafkaListenerContainerFactory<String, TaskEventDto> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, TaskEventDto> factory = new ConcurrentKafkaListenerContainerFactory<>();
